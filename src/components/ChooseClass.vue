              ...
              <div class="time-content">
                <ul class="clearfix">
                  <li v-for="(item,index) in lastorder" style="width: 100%;">
                    <div v-if="item.length >0" class="content">
...
//                self.$router.push({path:'/Login'})
    ...
    methods: {
      ...
      sure(){
        ...
        let self = this;
        this.$axios.get(this.ApiRoute.setuserschedule + '?oid=' + oid + '&date=' + selectMonth.date + '&hour_s=' + selectDate.time + '&type=0', {}, {
          headers: {
            "Content-Type": "application/json;charset=utf-8"
          },
          withCredentials: true
